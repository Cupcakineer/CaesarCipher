...
public class Cypher {
    ...
    private static String reverseRandom(String str, String key){
        ...
        for(int i=0; i<str.length(); i++){
            ...
            if('a' <= (str.charAt(i)) && (str.charAt(i)) <= 'z')
                original += key.charAt((int)str.charAt(i) - 97);
            else if('A' <= (str.charAt(i)) && (str.charAt(i)) <= 'Z') 
                original += Character.toUpperCase(key.charAt((int)str.charAt(i) - 65 ));
            else
    ...
    public static void main(String[] args) {
        ...
        //System.out.println(cye.convertWithRandomTable("Hello"));
        //printRandomKey();
        ...
        //System.out.println(reverseRandom("HELLO", "abcdwfgqijkemnrpqrstuvwxyz"));
